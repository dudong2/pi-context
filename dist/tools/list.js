...
export function register_context_list_tool(pi) {
    pi.registerTool({
        ...
        parameters: Type.Object({
            ...
            newer_than_days: Type.Optional(Type.Integer({
                minimum: 0,
                description: 'Only sources newer than N days',
            })),
            older_than_days: Type.Optional(Type.Integer({
                minimum: 0,
            ...
            limit: Type.Optional(Type.Integer({
                minimum: 1,
                maximum: 50,
                description: 'Maximum sources, default 10',
            })),
        ...
        async execute(...args) {
            ...
            const limited = limit_chat_output(format_list_results(results));
            return {
